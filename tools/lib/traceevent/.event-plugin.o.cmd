cmd_event-plugin.o := gcc -Wp,-MD,./.event-plugin.o.d -Wp,-MT,event-plugin.o -g -Wall -fPIC -I. -I /home/arnabjyoti/linux-4.14.3/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=\#s" -c -o event-plugin.o event-plugin.c
